...
os.environ["WANDB_PROJECT"] = "llama-2-7b-instruct-rl-deontology"
...
tokenizer = LlamaTokenizer.from_pretrained(
    script_args.tokenizer_name, model_max_length=512
)
...
def build_dataset(
    ...
    def preprocess_function(examples):
        ...
        # This needs to be human - assistant to match the SFT
...
model.pretrained_model.resize_token_embeddings(num_tokens)
