...
class ScriptArguments:
    ...
    train_dataset: str = field(
        metadata={"help": "What shall we use as the training data?"},
    )

    eval_dataset: str = field(
        metadata={"help": "What should be used as the test data?"},
    )
...
dataset = load_dataset(
    "csv",
    data_files={"train": script_args.train_dataset, "test": script_args.eval_dataset},
...
original_columns = train_dataset.column_names  # type: ignore
...
model.save_pretrained(script_args.output_name + "_peft_last_checkpoint")
